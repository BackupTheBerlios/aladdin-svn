 ...
 */
public class DeleteCarerAssessmentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.DeleteCarerAssessmentDocument
{
    ...
    private static final javax.xml.namespace.QName DELETECARERASSESSMENT$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "DeleteCarerAssessment");
    
    
    /**
     * Gets the "DeleteCarerAssessment" element
     */
    public eu.aladdin_project.scgen.DeleteCarerAssessmentDocument.DeleteCarerAssessment getDeleteCarerAssessment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.DeleteCarerAssessmentDocument.DeleteCarerAssessment target = null;
            target = (eu.aladdin_project.scgen.DeleteCarerAssessmentDocument.DeleteCarerAssessment)get_store().find_element_user(DELETECARERASSESSMENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDeleteCarerAssessment(eu.aladdin_project.scgen.DeleteCarerAssessmentDocument.DeleteCarerAssessment deleteCarerAssessment)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.DeleteCarerAssessmentDocument.DeleteCarerAssessment)get_store().add_element_user(DELETECARERASSESSMENT$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.DeleteCarerAssessmentDocument.DeleteCarerAssessment addNewDeleteCarerAssessment()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class DeleteCarerAssessmentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.DeleteCarerAssessmentDocument.DeleteCarerAssessment
    {
