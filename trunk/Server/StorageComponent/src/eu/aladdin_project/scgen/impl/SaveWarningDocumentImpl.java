 ...
 */
public class SaveWarningDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.SaveWarningDocument
{
    ...
    private static final javax.xml.namespace.QName SAVEWARNING$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "SaveWarning");
    
    
    /**
     * Gets the "SaveWarning" element
     */
    public eu.aladdin_project.scgen.SaveWarningDocument.SaveWarning getSaveWarning()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.SaveWarningDocument.SaveWarning target = null;
            target = (eu.aladdin_project.scgen.SaveWarningDocument.SaveWarning)get_store().find_element_user(SAVEWARNING$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSaveWarning(eu.aladdin_project.scgen.SaveWarningDocument.SaveWarning saveWarning)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.SaveWarningDocument.SaveWarning)get_store().add_element_user(SAVEWARNING$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.SaveWarningDocument.SaveWarning addNewSaveWarning()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class SaveWarningImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.SaveWarningDocument.SaveWarning
    {
