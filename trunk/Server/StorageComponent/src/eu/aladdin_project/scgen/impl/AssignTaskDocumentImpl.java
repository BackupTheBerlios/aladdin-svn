 ...
 */
public class AssignTaskDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.AssignTaskDocument
{
    ...
    private static final javax.xml.namespace.QName ASSIGNTASK$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "AssignTask");
    
    
    /**
     * Gets the "AssignTask" element
     */
    public eu.aladdin_project.scgen.AssignTaskDocument.AssignTask getAssignTask()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.AssignTaskDocument.AssignTask target = null;
            target = (eu.aladdin_project.scgen.AssignTaskDocument.AssignTask)get_store().find_element_user(ASSIGNTASK$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAssignTask(eu.aladdin_project.scgen.AssignTaskDocument.AssignTask assignTask)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.AssignTaskDocument.AssignTask)get_store().add_element_user(ASSIGNTASK$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.AssignTaskDocument.AssignTask addNewAssignTask()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class AssignTaskImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.AssignTaskDocument.AssignTask
    {
