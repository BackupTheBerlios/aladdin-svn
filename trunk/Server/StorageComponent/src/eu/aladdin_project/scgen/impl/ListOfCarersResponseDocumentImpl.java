 ...
 */
public class ListOfCarersResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfCarersResponseDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFCARERSRESPONSE$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "ListOfCarersResponse");
    
    
    /**
     * Gets the "ListOfCarersResponse" element
     */
    public eu.aladdin_project.scgen.ListOfCarersResponseDocument.ListOfCarersResponse getListOfCarersResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.ListOfCarersResponseDocument.ListOfCarersResponse target = null;
            target = (eu.aladdin_project.scgen.ListOfCarersResponseDocument.ListOfCarersResponse)get_store().find_element_user(LISTOFCARERSRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfCarersResponse(eu.aladdin_project.scgen.ListOfCarersResponseDocument.ListOfCarersResponse listOfCarersResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.ListOfCarersResponseDocument.ListOfCarersResponse)get_store().add_element_user(LISTOFCARERSRESPONSE$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.ListOfCarersResponseDocument.ListOfCarersResponse addNewListOfCarersResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfCarersResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfCarersResponseDocument.ListOfCarersResponse
    {
