 ...
 */
public class ListOfAdministratorsResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfAdministratorsResponseDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFADMINISTRATORSRESPONSE$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "ListOfAdministratorsResponse");
    
    
    /**
     * Gets the "ListOfAdministratorsResponse" element
     */
    public eu.aladdin_project.scgen.ListOfAdministratorsResponseDocument.ListOfAdministratorsResponse getListOfAdministratorsResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.ListOfAdministratorsResponseDocument.ListOfAdministratorsResponse target = null;
            target = (eu.aladdin_project.scgen.ListOfAdministratorsResponseDocument.ListOfAdministratorsResponse)get_store().find_element_user(LISTOFADMINISTRATORSRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfAdministratorsResponse(eu.aladdin_project.scgen.ListOfAdministratorsResponseDocument.ListOfAdministratorsResponse listOfAdministratorsResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.ListOfAdministratorsResponseDocument.ListOfAdministratorsResponse)get_store().add_element_user(LISTOFADMINISTRATORSRESPONSE$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.ListOfAdministratorsResponseDocument.ListOfAdministratorsResponse addNewListOfAdministratorsResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfAdministratorsResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfAdministratorsResponseDocument.ListOfAdministratorsResponse
    {
