 ...
 */
public class ListOfQuestionnairesResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfQuestionnairesResponseDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFQUESTIONNAIRESRESPONSE$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "ListOfQuestionnairesResponse");
    
    
    /**
     * Gets the "ListOfQuestionnairesResponse" element
     */
    public eu.aladdin_project.scgen.ListOfQuestionnairesResponseDocument.ListOfQuestionnairesResponse getListOfQuestionnairesResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.ListOfQuestionnairesResponseDocument.ListOfQuestionnairesResponse target = null;
            target = (eu.aladdin_project.scgen.ListOfQuestionnairesResponseDocument.ListOfQuestionnairesResponse)get_store().find_element_user(LISTOFQUESTIONNAIRESRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfQuestionnairesResponse(eu.aladdin_project.scgen.ListOfQuestionnairesResponseDocument.ListOfQuestionnairesResponse listOfQuestionnairesResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.ListOfQuestionnairesResponseDocument.ListOfQuestionnairesResponse)get_store().add_element_user(LISTOFQUESTIONNAIRESRESPONSE$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.ListOfQuestionnairesResponseDocument.ListOfQuestionnairesResponse addNewListOfQuestionnairesResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfQuestionnairesResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfQuestionnairesResponseDocument.ListOfQuestionnairesResponse
    {
