 ...
 */
public class GetPatientMeasurementDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.GetPatientMeasurementDocument
{
    ...
    private static final javax.xml.namespace.QName GETPATIENTMEASUREMENT$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "GetPatientMeasurement");
    
    
    /**
     * Gets the "GetPatientMeasurement" element
     */
    public eu.aladdin_project.scgen.GetPatientMeasurementDocument.GetPatientMeasurement getGetPatientMeasurement()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.GetPatientMeasurementDocument.GetPatientMeasurement target = null;
            target = (eu.aladdin_project.scgen.GetPatientMeasurementDocument.GetPatientMeasurement)get_store().find_element_user(GETPATIENTMEASUREMENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetPatientMeasurement(eu.aladdin_project.scgen.GetPatientMeasurementDocument.GetPatientMeasurement getPatientMeasurement)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.GetPatientMeasurementDocument.GetPatientMeasurement)get_store().add_element_user(GETPATIENTMEASUREMENT$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.GetPatientMeasurementDocument.GetPatientMeasurement addNewGetPatientMeasurement()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetPatientMeasurementImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.GetPatientMeasurementDocument.GetPatientMeasurement
    {
