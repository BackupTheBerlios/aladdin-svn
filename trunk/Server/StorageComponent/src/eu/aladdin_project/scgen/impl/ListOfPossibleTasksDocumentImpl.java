 ...
 */
public class ListOfPossibleTasksDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfPossibleTasksDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFPOSSIBLETASKS$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "ListOfPossibleTasks");
    
    
    /**
     * Gets the "ListOfPossibleTasks" element
     */
    public eu.aladdin_project.scgen.ListOfPossibleTasksDocument.ListOfPossibleTasks getListOfPossibleTasks()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.ListOfPossibleTasksDocument.ListOfPossibleTasks target = null;
            target = (eu.aladdin_project.scgen.ListOfPossibleTasksDocument.ListOfPossibleTasks)get_store().find_element_user(LISTOFPOSSIBLETASKS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfPossibleTasks(eu.aladdin_project.scgen.ListOfPossibleTasksDocument.ListOfPossibleTasks listOfPossibleTasks)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.ListOfPossibleTasksDocument.ListOfPossibleTasks)get_store().add_element_user(LISTOFPOSSIBLETASKS$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.ListOfPossibleTasksDocument.ListOfPossibleTasks addNewListOfPossibleTasks()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfPossibleTasksImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfPossibleTasksDocument.ListOfPossibleTasks
    {
