 ...
 */
public class CreateCarerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.CreateCarerDocument
{
    ...
    private static final javax.xml.namespace.QName CREATECARER$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "CreateCarer");
    
    
    /**
     * Gets the "CreateCarer" element
     */
    public eu.aladdin_project.scgen.CreateCarerDocument.CreateCarer getCreateCarer()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.CreateCarerDocument.CreateCarer target = null;
            target = (eu.aladdin_project.scgen.CreateCarerDocument.CreateCarer)get_store().find_element_user(CREATECARER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCreateCarer(eu.aladdin_project.scgen.CreateCarerDocument.CreateCarer createCarer)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.CreateCarerDocument.CreateCarer)get_store().add_element_user(CREATECARER$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.CreateCarerDocument.CreateCarer addNewCreateCarer()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class CreateCarerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.CreateCarerDocument.CreateCarer
    {
