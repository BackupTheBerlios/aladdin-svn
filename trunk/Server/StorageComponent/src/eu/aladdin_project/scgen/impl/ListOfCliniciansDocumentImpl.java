 ...
 */
public class ListOfCliniciansDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfCliniciansDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFCLINICIANS$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "ListOfClinicians");
    
    
    /**
     * Gets the "ListOfClinicians" element
     */
    public eu.aladdin_project.scgen.ListOfCliniciansDocument.ListOfClinicians getListOfClinicians()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.ListOfCliniciansDocument.ListOfClinicians target = null;
            target = (eu.aladdin_project.scgen.ListOfCliniciansDocument.ListOfClinicians)get_store().find_element_user(LISTOFCLINICIANS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfClinicians(eu.aladdin_project.scgen.ListOfCliniciansDocument.ListOfClinicians listOfClinicians)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.ListOfCliniciansDocument.ListOfClinicians)get_store().add_element_user(LISTOFCLINICIANS$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.ListOfCliniciansDocument.ListOfClinicians addNewListOfClinicians()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfCliniciansImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfCliniciansDocument.ListOfClinicians
    {
