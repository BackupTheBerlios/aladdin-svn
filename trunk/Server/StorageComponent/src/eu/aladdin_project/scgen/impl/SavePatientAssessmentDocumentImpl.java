 ...
 */
public class SavePatientAssessmentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.SavePatientAssessmentDocument
{
    ...
    private static final javax.xml.namespace.QName SAVEPATIENTASSESSMENT$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "SavePatientAssessment");
    
    
    /**
     * Gets the "SavePatientAssessment" element
     */
    public eu.aladdin_project.scgen.SavePatientAssessmentDocument.SavePatientAssessment getSavePatientAssessment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.SavePatientAssessmentDocument.SavePatientAssessment target = null;
            target = (eu.aladdin_project.scgen.SavePatientAssessmentDocument.SavePatientAssessment)get_store().find_element_user(SAVEPATIENTASSESSMENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSavePatientAssessment(eu.aladdin_project.scgen.SavePatientAssessmentDocument.SavePatientAssessment savePatientAssessment)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.SavePatientAssessmentDocument.SavePatientAssessment)get_store().add_element_user(SAVEPATIENTASSESSMENT$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.SavePatientAssessmentDocument.SavePatientAssessment addNewSavePatientAssessment()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class SavePatientAssessmentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.SavePatientAssessmentDocument.SavePatientAssessment
    {
