 ...
 */
public class ListOfCarersDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfCarersDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFCARERS$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/SCGen/", "ListOfCarers");
    
    
    /**
     * Gets the "ListOfCarers" element
     */
    public eu.aladdin_project.scgen.ListOfCarersDocument.ListOfCarers getListOfCarers()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.scgen.ListOfCarersDocument.ListOfCarers target = null;
            target = (eu.aladdin_project.scgen.ListOfCarersDocument.ListOfCarers)get_store().find_element_user(LISTOFCARERS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfCarers(eu.aladdin_project.scgen.ListOfCarersDocument.ListOfCarers listOfCarers)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.scgen.ListOfCarersDocument.ListOfCarers)get_store().add_element_user(LISTOFCARERS$0);
            }
     ...
     */
    public eu.aladdin_project.scgen.ListOfCarersDocument.ListOfCarers addNewListOfCarers()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfCarersImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.scgen.ListOfCarersDocument.ListOfCarers
    {
