 ...
 */
public class ListOfAdministratorsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfAdministratorsDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFADMINISTRATORS$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "ListOfAdministrators");
    
    
    /**
     * Gets the "ListOfAdministrators" element
     */
    public eu.aladdin_project.storagecomponent.ListOfAdministratorsDocument.ListOfAdministrators getListOfAdministrators()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.ListOfAdministratorsDocument.ListOfAdministrators target = null;
            target = (eu.aladdin_project.storagecomponent.ListOfAdministratorsDocument.ListOfAdministrators)get_store().find_element_user(LISTOFADMINISTRATORS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfAdministrators(eu.aladdin_project.storagecomponent.ListOfAdministratorsDocument.ListOfAdministrators listOfAdministrators)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.ListOfAdministratorsDocument.ListOfAdministrators)get_store().add_element_user(LISTOFADMINISTRATORS$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.ListOfAdministratorsDocument.ListOfAdministrators addNewListOfAdministrators()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfAdministratorsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfAdministratorsDocument.ListOfAdministrators
    {
