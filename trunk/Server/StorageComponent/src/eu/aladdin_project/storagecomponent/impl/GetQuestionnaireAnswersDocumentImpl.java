 ...
 */
public class GetQuestionnaireAnswersDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.GetQuestionnaireAnswersDocument
{
    ...
    private static final javax.xml.namespace.QName GETQUESTIONNAIREANSWERS$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "GetQuestionnaireAnswers");
    
    
    /**
     * Gets the "GetQuestionnaireAnswers" element
     */
    public eu.aladdin_project.storagecomponent.GetQuestionnaireAnswersDocument.GetQuestionnaireAnswers getGetQuestionnaireAnswers()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.GetQuestionnaireAnswersDocument.GetQuestionnaireAnswers target = null;
            target = (eu.aladdin_project.storagecomponent.GetQuestionnaireAnswersDocument.GetQuestionnaireAnswers)get_store().find_element_user(GETQUESTIONNAIREANSWERS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetQuestionnaireAnswers(eu.aladdin_project.storagecomponent.GetQuestionnaireAnswersDocument.GetQuestionnaireAnswers getQuestionnaireAnswers)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.GetQuestionnaireAnswersDocument.GetQuestionnaireAnswers)get_store().add_element_user(GETQUESTIONNAIREANSWERS$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.GetQuestionnaireAnswersDocument.GetQuestionnaireAnswers addNewGetQuestionnaireAnswers()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetQuestionnaireAnswersImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.GetQuestionnaireAnswersDocument.GetQuestionnaireAnswers
    {
