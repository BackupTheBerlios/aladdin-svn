 ...
 */
public class GetWarningsResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.GetWarningsResponseDocument
{
    ...
    private static final javax.xml.namespace.QName GETWARNINGSRESPONSE$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "GetWarningsResponse");
    
    
    /**
     * Gets the "GetWarningsResponse" element
     */
    public eu.aladdin_project.storagecomponent.GetWarningsResponseDocument.GetWarningsResponse getGetWarningsResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.GetWarningsResponseDocument.GetWarningsResponse target = null;
            target = (eu.aladdin_project.storagecomponent.GetWarningsResponseDocument.GetWarningsResponse)get_store().find_element_user(GETWARNINGSRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetWarningsResponse(eu.aladdin_project.storagecomponent.GetWarningsResponseDocument.GetWarningsResponse getWarningsResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.GetWarningsResponseDocument.GetWarningsResponse)get_store().add_element_user(GETWARNINGSRESPONSE$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.GetWarningsResponseDocument.GetWarningsResponse addNewGetWarningsResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetWarningsResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.GetWarningsResponseDocument.GetWarningsResponse
    {
