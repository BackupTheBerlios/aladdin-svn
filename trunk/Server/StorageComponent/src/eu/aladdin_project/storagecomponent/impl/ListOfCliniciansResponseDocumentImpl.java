 ...
 */
public class ListOfCliniciansResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfCliniciansResponseDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFCLINICIANSRESPONSE$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "ListOfCliniciansResponse");
    
    
    /**
     * Gets the "ListOfCliniciansResponse" element
     */
    public eu.aladdin_project.storagecomponent.ListOfCliniciansResponseDocument.ListOfCliniciansResponse getListOfCliniciansResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.ListOfCliniciansResponseDocument.ListOfCliniciansResponse target = null;
            target = (eu.aladdin_project.storagecomponent.ListOfCliniciansResponseDocument.ListOfCliniciansResponse)get_store().find_element_user(LISTOFCLINICIANSRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfCliniciansResponse(eu.aladdin_project.storagecomponent.ListOfCliniciansResponseDocument.ListOfCliniciansResponse listOfCliniciansResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.ListOfCliniciansResponseDocument.ListOfCliniciansResponse)get_store().add_element_user(LISTOFCLINICIANSRESPONSE$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.ListOfCliniciansResponseDocument.ListOfCliniciansResponse addNewListOfCliniciansResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfCliniciansResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfCliniciansResponseDocument.ListOfCliniciansResponse
    {
