 ...
 */
public class ListOfPatientsResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfPatientsResponseDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFPATIENTSRESPONSE$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "ListOfPatientsResponse");
    
    
    /**
     * Gets the "ListOfPatientsResponse" element
     */
    public eu.aladdin_project.storagecomponent.ListOfPatientsResponseDocument.ListOfPatientsResponse getListOfPatientsResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.ListOfPatientsResponseDocument.ListOfPatientsResponse target = null;
            target = (eu.aladdin_project.storagecomponent.ListOfPatientsResponseDocument.ListOfPatientsResponse)get_store().find_element_user(LISTOFPATIENTSRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfPatientsResponse(eu.aladdin_project.storagecomponent.ListOfPatientsResponseDocument.ListOfPatientsResponse listOfPatientsResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.ListOfPatientsResponseDocument.ListOfPatientsResponse)get_store().add_element_user(LISTOFPATIENTSRESPONSE$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.ListOfPatientsResponseDocument.ListOfPatientsResponse addNewListOfPatientsResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfPatientsResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfPatientsResponseDocument.ListOfPatientsResponse
    {
