...
drop sequence AladdinUsers_id_seq;
...
create table AladdinUsers (id int4 not null, username varchar(255), password varchar(255), type int4, personId varchar(255), primary key (id));
...
alter table Task add constraint FK27A9A5584C2072 foreign key (Executor) references AladdinUsers;
...
alter table Task add constraint FK27A9A5C87A357B foreign key (Assigner) references AladdinUsers;
...
alter table Task add constraint FK27A9A5A186CADE foreign key (Object) references AladdinUsers;
...
create sequence AladdinUsers_id_seq;
