...
echo "public static String hibernateCfg = \"/hibernate-aladdin-sc-dafni.cfg.xml\";" >> src/com/aladdin/sc/config/Configuration.java
echo "public static String forumSC = \"http://dafnis.atosorigin.es/DAFNI/Aladdin/includes/sc.php\";" >> src/com/aladdin/sc/config/Configuration.java
...
cat ./src/com/aladdin/raac/RaacStub.java|sed 's/http:\/\/193.174.152.114:8080\/axis2\/services\/raac\//http:\/\/193.174.152.114:8080\/axis2\/services\/raacDAFNI\//' > tmp
