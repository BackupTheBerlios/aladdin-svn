...
cat ./src/com/aladdin/sc/StorageComponentStub.java|sed 's/http:\/\/193.174.152.114:8080\/axis2\/services\/StorageComponent\//http:\/\/127.0.0.1:8080\/axis2\/services\/SCDAFNI\//'>tmp
