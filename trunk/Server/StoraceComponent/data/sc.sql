...
alter table Measurment drop constraint FKE6F5FDE5F61D4E73;
...
drop sequence Measurment_id_seq;
...
create table Measurment (id int4 not null, type varchar(255), value numeric(19, 2), datetime timestamp, units varchar(255), lowerlimit numeric(19, 2), upperlimit numeric(19, 2), pa int4, primary key (id));
create table Note (id int4 not null, DateTimeOfNote timestamp, text varchar(255), primary key (id));
...
create table QuestionnaireAnswer (id int4 not null, question int4, value varchar(255), primary key (id));
...
create table Task (id int4 not null, TaskType int4, DateTimeAssigned timestamp, DateTimeFulfilled timestamp, TaskStatus int4, url varchar(255), questionnaire int4, primary key (id));
...
alter table Measurment add constraint FKE6F5FDE5F61D4E73 foreign key (pa) references PatientAssessment;
...
create sequence Measurment_id_seq;
