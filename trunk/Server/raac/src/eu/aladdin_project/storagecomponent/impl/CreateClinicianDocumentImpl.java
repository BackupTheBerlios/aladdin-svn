 ...
 */
public class CreateClinicianDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.CreateClinicianDocument
{
    ...
    private static final javax.xml.namespace.QName CREATECLINICIAN$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "CreateClinician");
    
    
    /**
     * Gets the "CreateClinician" element
     */
    public eu.aladdin_project.storagecomponent.CreateClinicianDocument.CreateClinician getCreateClinician()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.CreateClinicianDocument.CreateClinician target = null;
            target = (eu.aladdin_project.storagecomponent.CreateClinicianDocument.CreateClinician)get_store().find_element_user(CREATECLINICIAN$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCreateClinician(eu.aladdin_project.storagecomponent.CreateClinicianDocument.CreateClinician createClinician)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.CreateClinicianDocument.CreateClinician)get_store().add_element_user(CREATECLINICIAN$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.CreateClinicianDocument.CreateClinician addNewCreateClinician()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class CreateClinicianImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.CreateClinicianDocument.CreateClinician
    {
