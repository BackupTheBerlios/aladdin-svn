 ...
 */
public class ListOfPatientsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfPatientsDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFPATIENTS$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "ListOfPatients");
    
    
    /**
     * Gets the "ListOfPatients" element
     */
    public eu.aladdin_project.storagecomponent.ListOfPatientsDocument.ListOfPatients getListOfPatients()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.ListOfPatientsDocument.ListOfPatients target = null;
            target = (eu.aladdin_project.storagecomponent.ListOfPatientsDocument.ListOfPatients)get_store().find_element_user(LISTOFPATIENTS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfPatients(eu.aladdin_project.storagecomponent.ListOfPatientsDocument.ListOfPatients listOfPatients)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.ListOfPatientsDocument.ListOfPatients)get_store().add_element_user(LISTOFPATIENTS$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.ListOfPatientsDocument.ListOfPatients addNewListOfPatients()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfPatientsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfPatientsDocument.ListOfPatients
    {
