 ...
 */
public class GetWarningsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.GetWarningsDocument
{
    ...
    private static final javax.xml.namespace.QName GETWARNINGS$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "GetWarnings");
    
    
    /**
     * Gets the "GetWarnings" element
     */
    public eu.aladdin_project.storagecomponent.GetWarningsDocument.GetWarnings getGetWarnings()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.GetWarningsDocument.GetWarnings target = null;
            target = (eu.aladdin_project.storagecomponent.GetWarningsDocument.GetWarnings)get_store().find_element_user(GETWARNINGS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetWarnings(eu.aladdin_project.storagecomponent.GetWarningsDocument.GetWarnings getWarnings)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.GetWarningsDocument.GetWarnings)get_store().add_element_user(GETWARNINGS$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.GetWarningsDocument.GetWarnings addNewGetWarnings()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetWarningsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.GetWarningsDocument.GetWarnings
    {
