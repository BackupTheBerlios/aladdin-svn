...
public class StorageComponentSOAPStub extends org.apache.axis.client.Stub implements eu.aladdin_project.StorageComponent.StorageComponent_PortType {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {locale, userId});
  ...
  throw axisFaultException;
    ...
    public eu.aladdin_project.xsd.QuestionnaireQuestion[] getQuestionnaire(java.lang.String id, eu.aladdin_project.xsd.SystemParameter locale, java.lang.String userId) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {id, locale, userId});
  ...
  throw axisFaultException;
    ...
    public eu.aladdin_project.xsd.OperationResult updateQuestionnaire(eu.aladdin_project.xsd.QuestionnaireQuestion[] data, eu.aladdin_project.xsd.SystemParameter locale, java.lang.String userId) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {data, locale, userId});
  ...
  throw axisFaultException;
    ...
    public eu.aladdin_project.xsd.OperationResult createQuestionnaire(eu.aladdin_project.xsd.QuestionnaireQuestion[] data, eu.aladdin_project.xsd.SystemParameter locale, java.lang.String userId) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {filter, userId});
  ...
  throw axisFaultException;
    ...
    public eu.aladdin_project.xsd.QuestionnaireAnswer[] getQuestionnaireAnswersByTask(java.lang.String taskId, java.lang.String userId) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
