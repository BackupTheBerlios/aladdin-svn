...
public class PatientInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the surname value for this PatientInfo.
     * 
     * @return surname
     */
    ...
    /**
     * Sets the surname value for this PatientInfo.
     * 
     * @param surname
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://aladdin-project.eu/xsd", "PatientInfo"));
