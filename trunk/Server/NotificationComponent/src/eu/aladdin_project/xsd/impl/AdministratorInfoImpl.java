 ...
 */
public class AdministratorInfoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.xsd.AdministratorInfo
{
    
    public AdministratorInfoImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public org.apache.xmlbeans.XmlString xgetSurname()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(SURNAME$2, 0);
            return target;
        }
    }
    ...
    public void xsetSurname(org.apache.xmlbeans.XmlString surname)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(SURNAME$2);
            }
            target.set(surname);
        }
    }
