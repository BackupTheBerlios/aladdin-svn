...
namespace Aladdin.ClientApplication.ViewModels
{
    class ChooseOneAnswerFrom2ControlViewModel : INotifyPropertyChanged
    {
        ...
        {
            this.Wizard.Answers.SetAnswer(this.Wizard.ActiveQuestion.ID, this.Wizard.ActiveQuestion.Answers[0].Value);
        ...
        {
            this.Wizard.Answers.SetAnswer(this.Wizard.ActiveQuestion.ID, this.Wizard.ActiveQuestion.Answers[1].Value);
            this.Wizard.OnQuestionAnswered();
            this.Wizard.MoveNext();
        }
    }
