 ...
 */
public class SaveCarerAssessmentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.SaveCarerAssessmentDocument
{
    ...
    private static final javax.xml.namespace.QName SAVECARERASSESSMENT$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "SaveCarerAssessment");
    
    
    /**
     * Gets the "SaveCarerAssessment" element
     */
    public eu.aladdin_project.storagecomponent.SaveCarerAssessmentDocument.SaveCarerAssessment getSaveCarerAssessment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.SaveCarerAssessmentDocument.SaveCarerAssessment target = null;
            target = (eu.aladdin_project.storagecomponent.SaveCarerAssessmentDocument.SaveCarerAssessment)get_store().find_element_user(SAVECARERASSESSMENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSaveCarerAssessment(eu.aladdin_project.storagecomponent.SaveCarerAssessmentDocument.SaveCarerAssessment saveCarerAssessment)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.SaveCarerAssessmentDocument.SaveCarerAssessment)get_store().add_element_user(SAVECARERASSESSMENT$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.SaveCarerAssessmentDocument.SaveCarerAssessment addNewSaveCarerAssessment()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class SaveCarerAssessmentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.SaveCarerAssessmentDocument.SaveCarerAssessment
    {
