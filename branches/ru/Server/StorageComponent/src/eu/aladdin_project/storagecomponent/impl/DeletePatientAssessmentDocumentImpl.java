 ...
 */
public class DeletePatientAssessmentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.DeletePatientAssessmentDocument
{
    ...
    private static final javax.xml.namespace.QName DELETEPATIENTASSESSMENT$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "DeletePatientAssessment");
    
    
    /**
     * Gets the "DeletePatientAssessment" element
     */
    public eu.aladdin_project.storagecomponent.DeletePatientAssessmentDocument.DeletePatientAssessment getDeletePatientAssessment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.DeletePatientAssessmentDocument.DeletePatientAssessment target = null;
            target = (eu.aladdin_project.storagecomponent.DeletePatientAssessmentDocument.DeletePatientAssessment)get_store().find_element_user(DELETEPATIENTASSESSMENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDeletePatientAssessment(eu.aladdin_project.storagecomponent.DeletePatientAssessmentDocument.DeletePatientAssessment deletePatientAssessment)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.DeletePatientAssessmentDocument.DeletePatientAssessment)get_store().add_element_user(DELETEPATIENTASSESSMENT$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.DeletePatientAssessmentDocument.DeletePatientAssessment addNewDeletePatientAssessment()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class DeletePatientAssessmentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.DeletePatientAssessmentDocument.DeletePatientAssessment
    {
