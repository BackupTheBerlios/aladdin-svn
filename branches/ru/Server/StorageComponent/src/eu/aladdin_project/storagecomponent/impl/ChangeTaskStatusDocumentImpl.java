 ...
 */
public class ChangeTaskStatusDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ChangeTaskStatusDocument
{
    ...
    private static final javax.xml.namespace.QName CHANGETASKSTATUS$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "ChangeTaskStatus");
    
    
    /**
     * Gets the "ChangeTaskStatus" element
     */
    public eu.aladdin_project.storagecomponent.ChangeTaskStatusDocument.ChangeTaskStatus getChangeTaskStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.ChangeTaskStatusDocument.ChangeTaskStatus target = null;
            target = (eu.aladdin_project.storagecomponent.ChangeTaskStatusDocument.ChangeTaskStatus)get_store().find_element_user(CHANGETASKSTATUS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setChangeTaskStatus(eu.aladdin_project.storagecomponent.ChangeTaskStatusDocument.ChangeTaskStatus changeTaskStatus)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.ChangeTaskStatusDocument.ChangeTaskStatus)get_store().add_element_user(CHANGETASKSTATUS$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.ChangeTaskStatusDocument.ChangeTaskStatus addNewChangeTaskStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ChangeTaskStatusImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ChangeTaskStatusDocument.ChangeTaskStatus
    {
