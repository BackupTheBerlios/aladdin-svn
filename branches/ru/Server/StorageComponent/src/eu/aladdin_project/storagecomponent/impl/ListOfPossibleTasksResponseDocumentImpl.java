 ...
 */
public class ListOfPossibleTasksResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfPossibleTasksResponseDocument
{
    ...
    private static final javax.xml.namespace.QName LISTOFPOSSIBLETASKSRESPONSE$0 = 
        new javax.xml.namespace.QName("http://aladdin-project.eu/StorageComponent/", "ListOfPossibleTasksResponse");
    
    
    /**
     * Gets the "ListOfPossibleTasksResponse" element
     */
    public eu.aladdin_project.storagecomponent.ListOfPossibleTasksResponseDocument.ListOfPossibleTasksResponse getListOfPossibleTasksResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.aladdin_project.storagecomponent.ListOfPossibleTasksResponseDocument.ListOfPossibleTasksResponse target = null;
            target = (eu.aladdin_project.storagecomponent.ListOfPossibleTasksResponseDocument.ListOfPossibleTasksResponse)get_store().find_element_user(LISTOFPOSSIBLETASKSRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListOfPossibleTasksResponse(eu.aladdin_project.storagecomponent.ListOfPossibleTasksResponseDocument.ListOfPossibleTasksResponse listOfPossibleTasksResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.aladdin_project.storagecomponent.ListOfPossibleTasksResponseDocument.ListOfPossibleTasksResponse)get_store().add_element_user(LISTOFPOSSIBLETASKSRESPONSE$0);
            }
     ...
     */
    public eu.aladdin_project.storagecomponent.ListOfPossibleTasksResponseDocument.ListOfPossibleTasksResponse addNewListOfPossibleTasksResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListOfPossibleTasksResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.aladdin_project.storagecomponent.ListOfPossibleTasksResponseDocument.ListOfPossibleTasksResponse
    {
